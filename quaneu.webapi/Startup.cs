...
using quaneu.datalayer.Repository;
...
namespace quaneu.webapi
{
    ...
    {
#warning get key from somewhere secure; 
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("QuanUser", policy => policy.RequireClaim(Constants.Strings.JwtClaimIdentifiers.Rol, Constants.Strings.JwtClaims.ApiAccess));
